...
namespace Core.Helpers
{
    ...
    public static class MathCore
    {
        ...
        /// <summary>
        ///   <para>Returns the sign of d.</para>
        /// </summary>
        /// <param name="d"></param>
        ...
        /// <summary>
        ///   <para>Returns the sign of i.</para>
        /// </summary>
        /// <param name="i"></param>
        ...
        /// <summary>
        ///   <para>Clamps a value between a minimum double and maximum double value.</para>
        /// </summary>
        /// <param name="value"></param>
        /// <param name="min"></param>
        /// <param name="max"></param>
        ...
        {
            return a + (b - a) * MathCore.Clamp01(t);
        }
        ...
        {
            float num = MathCore.Repeat(b - a, 360f);
            if ((double)num > 180.0)
                num -= 360f;
            return a + num * MathCore.Clamp01(t);
        }
        ...
        {
            if ((double)Math.Abs(target - current) <= (double)maxDelta)
                return target;
        ...
        {
            target = current + MathCore.DeltaAngle(current, target);
            return MathCore.MoveTowards(current, target, maxDelta);
        }
        ...
        public static float Gamma(float value, float absmax, float gamma)
        {
            ...
            float num2 = MathCore.Pow(num1 / absmax, gamma) * absmax;
            if (flag)
                return -num2;
            return num2;
        }
        ...
        {
            return (double)Math.Abs(b - a) < (double)Math.Max(1E-06f * Math.Max(Math.Abs(a), Math.Abs(b)), MathCore.Epsilon * 8f);
        }
        ...
        public static float SmoothDamp(float current, float target, ref float currentVelocity, float smoothTime, float maxSpeed, float deltaTime)
        {
            ...
            float num6 = MathCore.Clamp(num4, -max, max);
            target = current - num6;
        ...
        {
            target = current + MathCore.DeltaAngle(current, target);
            return MathCore.SmoothDamp(current, target, ref currentVelocity, smoothTime, maxSpeed, deltaTime);
        }
        ...
        {
            return t - MathCore.Floor(t / length) * length;
        }
        ...
        {
            if ((double)a != (double)b)
                return MathCore.Clamp01((float)(((double)value - (double)a) / ((double)b - (double)a)));
            return 0.0f;
        }

        /// <summary>
        ///   <para>Returns the closest power of two value.</para>
        ///   Larger result has priority.
        /// </summary>
        /// <param name="value"></param>
        public static int ClosestPowerOfTwo(int value)
        {
            int next = MathCore.NextPowerOfTwo(value);
            int prev = next >> 1;
        ...
        {
            return 255f * MathCore.Pow(value / 255f, 2.2f);
        }
        ...
        {
            return 255f * MathCore.Pow(value / 255f, 0.4545f); //0.4545 == 1/2.2
        }
        ...
        {
            float num = MathCore.Repeat(target - current, 360f);
            if ((double)num > 180.0)
                num -= 360f;
            return num;
        }
        ...
        internal static bool LineIntersection(Float2 p1, Float2 p2, Float2 p3, Float2 p4, ref Float2 result)
        {
            ...
            result = new Float2(p1.x + num8 * num1, p1.y + num8 * num2);
            return true;
        }
